...
const Docs = {
  ...
  _buildHTML(rec) {
    ...
    const header = isSamos
      ...
      : `<div class="pz-hd-tech">
           ...
           <div class="pz-tech-svcs">
             CCTV Camera &middot; Electric Fence &middot; Gate Motor &middot;
             Video Door Phone &middot; Fire Alarm &middot; Access Control &middot;
             PBX Phone &middot; Internet &amp; ICT Services
           </div>
         </div>`;
    ...
    // ── TECH: personal mobile money + personal bank accounts
    const techPay = `
      <div class="pz-pay">
        ...
        <div class="pz-mobiles">
          ...
          <div class="pz-mob">
            <img src="https://i.ibb.co/FLQ2MVxQ/mixx-logo-removebg-preview.webp" alt="Tigo" />
            <div class="mn">Tigo Pesa</div>
            <div class="mnum">—</div>
            <div class="mh">Amos Spear Massam</div>
          </div>
          <div class="pz-mob">
            <img src="https://i.ibb.co/S4mp6TbX/applications-system-removebg-preview.webp" alt="Halo" />
            <div class="mn">HaloPesa</div>
            <div class="mnum">—</div>
            <div class="mh">Amos Spear Massam</div>
          </div>
        </div>
  ...
  _exportWord(rec) {
    ...
    const header = isSamos
      ...
      : `<div style="text-align:center;border-bottom:4px solid #f97316;padding-bottom:12px;margin-bottom:10px">
           <h1 style="font-size:24px;font-weight:900;color:#0f172a;letter-spacing:3px;margin:0 0 5px">
             TECHNICAL SERVICES
           </h1>
           <p style="font-size:11px;color:#64748b;margin:0 0 2px;font-weight:600">
             Deal with Installation and Maintenance / Service of:
           </p>
           <p style="font-size:10px;color:#94a3b8;margin:0">
             CCTV Camera · Electric Fence · Gate Motor · Video Door Phone ·
             Fire Alarm · Access Control · PBX Phone · Internet &amp; ICT Services
           </p>
         </div>`;
...
<table style="width:100%;border-collapse:collapse;margin-bottom:10px">
  <tr>
    <td style="border:1px solid #e2e8f0;padding:9px;background:#f8fafc;width:50%;vertical-align:top">
      <strong>CRDB BANK</strong><br>Acc: 0152687656400<br>
      <small style="color:#64748b">Amos Spear Massam</small>
    </td>
    <td style="border:1px solid #e2e8f0;padding:9px;background:#f8fafc;width:50%;vertical-align:top">
      <strong>NMB BANK</strong><br>Acc: 52510010760<br>
      <small style="color:#64748b">Amos Spear Massam</small>
    </td>
  </tr>
  <tr>
    <td style="border:1px solid #e2e8f0;padding:9px;background:#f8fafc;vertical-align:top">
      <strong>Airtel Money:</strong> 0784 042 020<br>
      <small style="color:#64748b">Amos Spear Massam</small>
    </td>
    <td style="border:1px solid #e2e8f0;padding:9px;background:#f8fafc;vertical-align:top">
      <strong>M-Pesa:</strong> 0755 747 340<br>
      <small style="color:#64748b">Amos Spear Massam</small>
    </td>
  </tr>
  <tr>
    <td style="border:1px solid #e2e8f0;padding:9px;background:#f8fafc;vertical-align:top">
      <strong>Tigo Pesa</strong> — Amos Spear Massam
    </td>
    <td style="border:1px solid #e2e8f0;padding:9px;background:#f8fafc;vertical-align:top">
      <strong>HaloPesa</strong> — Amos Spear Massam
    </td>
  </tr>
</table>`;
