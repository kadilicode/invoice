  ...
  _buildHTML(rec) {
    ...
    const techPay = `
      <div class="pz-pay">
        ...
        <div class="pz-mobiles pz-mobiles-2">
          <div class="pz-mob">
            <img src="https://i.ibb.co/zVJrmYn1/images-removebg-preview.webp" alt="Airtel" />
            <div><div class="mn">Airtel Money</div><div class="mnum">0784 042 020</div><div class="mh">Amos Spear Massam</div></div>
          </div>
          <div class="pz-mob">
            <img src="https://i.ibb.co/5Xmzv2kq/M-pesa-logo-removebg-preview.webp" alt="M-Pesa" />
            <div><div class="mn">M-Pesa</div><div class="mnum">0755 747 340</div><div class="mh">Amos Spear Massam</div></div>
          </div>
        </div>
      </div>`;
